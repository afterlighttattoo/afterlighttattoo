...
export function BookingForm({ artists, initialArtist = "" }: { artists: Artist[]; initialArtist?: string }) {
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const requiredFields: Array<[string, string]> = [
      ...
      ["preferredArtist", "Choose an artist or ask for a recommendation."],
      ["concept", "Tell us about your tattoo concept."],
      ["placement", "Enter your preferred placement."],
      ["size", "Enter an approximate size."],
      ["finish", "Choose black-and-gray, color, or undecided."],
      ["budget", "Enter a comfortable budget range."],
  ...
  return (
    <form className="booking-form" id="consultation-form" onSubmit={handleSubmit} noValidate>
      ...
      <div className="form-status" role="note">
        Online consultation delivery is currently being finalized. Please contact the studio through Instagram or Facebook if you experience an issue.
      </div>
      {submitted && <div className="success-message" role="status"><strong>Your information has been checked.</strong> It was not sent because online delivery is still being finalized. Please contact the studio through Instagram or Facebook.</div>}
      ...
      <fieldset className="form-section">
        ...
        <div className="form-grid">
          <div className="field-group field-wide">
            ...
            <textarea id="concept" name="concept" rows={5} placeholder="Describe the subject, mood, and details you want the artist to consider." aria-invalid={!!errors.concept} aria-describedby={describedBy("concept")} />
            {error("concept")}
          </div>
          <div className="field-group">
          ...
          <div className="field-group">
            ...
            <input id="size" name="size" placeholder="Dimensions or an object for scale" aria-invalid={!!errors.size} aria-describedby={describedBy("size")} />
            {error("size")}
          </div>
      ...
      <fieldset className="form-section">
        ...
        <div className="form-grid">
          ...
          <div className="field-group field-wide">
            ...
            <textarea id="details" name="details" rows={4} placeholder="Share scheduling context, cover-up details, accessibility needs, or questions." />
          </div>
        </div>
      </fieldset>
